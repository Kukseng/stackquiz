    ...
    <div className={`min-h-screen flex flex-col items-center justify-center p-4 ${fontClass}`}>
      <div className="flex flex-col md:flex-row w-full max-w-6xl rounded-3xl lg:border-8 border-white/70 transition-transform duration-500 shadow-2xl">
        ...
        <div className="hidden md:flex flex-col items-center justify-center w-1/2 p-6 rounded-l-2xl bg-pink-100 relative overflow-hidden">
          ...
          <div className="mt-8">
            <Image src="/signup.png" alt="Signup illustration" width={400} height={400} />
          </div>
        </div>
        ...
        <div className="flex-1 w-full md:w-1/2 p-4 md:p-6 bg-white rounded-2xl md:rounded-r-2xl md:rounded-l-none">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <FormField
                ...
                toggleIcon={showPassword ? <HiOutlineEyeOff className="h-4 w-4 text-gray-400 cursor-pointer" /> : <HiOutlineEye className="h-4 w-4 text-gray-400 cursor-pointer" />}
              />
              <FormField
                id="confirmPassword"
                ...
                toggleIcon={showConfirmPassword ? <HiOutlineEyeOff className="h-4 w-4 text-gray-400 cursor-pointer" /> : <HiOutlineEye className="h-4 w-4 text-gray-400 cursor-pointer" />}
              />
            </div>
          ...
          <div className="flex justify-center space-x-2">
            <button type="button" onClick={() => signIn("google", { callbackUrl: "/dashboard" })} className="transition-transform duration-200 hover:scale-110">
              <Image src="/social_media_icon/google.svg" alt="Google Icon" width={40} height={40} />
            </button>
            <button type="button" onClick={() => signIn("github", { callbackUrl: "/dashboard" })} className="transition-transform duration-200 hover:scale-110">
              <Image src="/social_media_icon/github.svg" alt="GitHub Icon" width={36} height={36} />
            </button>
            <button type="button" onClick={() => signIn("facebook", { callbackUrl: "/dashboard" })} className="transition-transform duration-200 hover:scale-110">
