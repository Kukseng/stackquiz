...
//                 (question.accuracyRate ?? 0) >= 70 ? "text-green-600" :
//                 (question.accuracyRate ?? 0) >= 40 ? "text-yellow-600" :
//                 "text-red-600"
//               }`}>
//                 {(question.accuracyRate ?? 0).toFixed(0)}%
//               </div>
...
//             </div>
//           ) : (
//             <div className="text-gray-500 italic p-3 bg-gray-50 rounded-lg">No options available for this question type.</div>
//           )}

//           {/* Avg Response Time */}
//           <div className="mt-4 text-center text-sm text-gray-600">
//             ⏱️ Average response time: <span className="font-bold">{(question.averageResponseTime ?? 0).toFixed(1)}s</span>
//           </div>
//         </motion.div>
//       ))}
//     </motion.div>
...
//               </div>
//               <div className="text-center">
//                 <div className="text-lg font-bold text-green-600">{(participant.accuracy ?? 0).toFixed(1)}%</div>
//                 <div className="text-xs text-gray-500">Accuracy</div>
//               </div>
//               <div className="text-center">
...
//                   {(participant.averageResponseTime ?? 0).toFixed(1)}s
//                 </div>
...
//               {(100 - (insights?.dropoffRate ?? 0)).toFixed(1)}%
//             </div>
...
//               {insights?.difficultyBalance || 'N/A'}
//             </div>
...
//   const maxCount = Math.max(...ranges.map((r) => r.count), 1); // Avoid division by zero
...
// SessionReportUI.tsx
// Quizizz-style Session Report Component for Host Dashboard
// Place this file in: components/dashboard-host/SessionReportUI.tsx
...
//           <div className="flex items-center justify-between">
//             <div>
//               <h1 className="text-3xl font-bold text-gray-800 mb-2">📊 Session Report</h1>
//               <p className="text-gray-600">{reportData.quizTitle} • Session: {reportData.sessionCode}</p>
//               <p className="text-sm text-gray-500">Hosted by {reportData.hostName} • {new Date(reportData.startTime).toLocaleString()}</p>
//             </div>
//             <div className="flex items-center space-x-2">
//               <select
//                 value={exportFormat}
...
//           <div className="p-6">
//             <AnimatePresence mode="wait">
//               {activeTab === "overview" && <OverviewTab key="overview" data={reportData} />}
//               {activeTab === "questions" && (
//                 <QuestionsTab key="questions" questions={reportData.questionAnalysis} />
//               )}
//               {activeTab === "participants" && (
...
//     >
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
//         <MetricCard icon="👥" label="Total Participants" value={stats.totalParticipants} color="blue" />
//         <MetricCard icon="✅" label="Completion Rate" value={`${stats.completionRate.toFixed(1)}%`} color="green" />
//         <MetricCard icon="🎯" label="Average Accuracy" value={`${stats.averageAccuracy.toFixed(1)}%`} color="purple" />
//         <MetricCard icon="⏱️" label="Avg Response Time" value={`${stats.averageResponseTime.toFixed(1)}s`} color="orange" />
//       </div>
//       <div className="bg-gray-50 rounded-xl p-6">
//         <h3 className="text-xl font-bold text-gray-800 mb-4">📊 Score Distribution</h3>
//         <ScoreDistributionChart participants={data.participantReports} />
...
//           <h3 className="text-lg font-bold text-blue-800 mb-4">📝 Quiz Details</h3>
//           <div className="space-y-2 text-sm">
//             <div className="flex justify-between"><span className="text-blue-700">Total Questions:</span><span className="font-bold text-blue-900">{stats.totalQuestions}</span></div>
//             <div className="flex justify-between"><span className="text-blue-700">Total Answers:</span><span className="font-bold text-blue-900">{stats.totalAnswers}</span></div>
//             <div className="flex justify-between"><span className="text-blue-700">Correct Answers:</span><span className="font-bold text-green-600">{stats.correctAnswers}</span></div>
//             <div className="flex justify-between"><span className="text-blue-700">Incorrect Answers:</span><span className="font-bold text-red-600">{stats.incorrectAnswers}</span></div>
//           </div>
//         </div>
//         <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6">
//           <h3 className="text-lg font-bold text-purple-800 mb-4">⏰ Session Timeline</h3>
//           <div className="space-y-2 text-sm">
//             <div className="flex justify-between"><span className="text-purple-700">Started:</span><span className="font-bold text-purple-900">{new Date(data.startTime).toLocaleString()}</span></div>
//             <div className="flex justify-between"><span className="text-purple-700">Ended:</span><span className="font-bold text-purple-900">{new Date(data.endTime).toLocaleString()}</span></div>
//             <div className="flex justify-between"><span className="text-purple-700">Duration:</span><span className="font-bold text-purple-900">{Math.floor(data.duration / 60)}m {data.duration % 60}s</span></div>
//             <div className="flex justify-between"><span className="text-purple-700">Status:</span><span className="font-bold text-purple-900">{data.status}</span></div>
//           </div>
//         </div>
//       </div>
//     </motion.div>
...
//             <div className="flex-1">
//               <div className="flex items-center space-x-3 mb-2">
//                 <span className="text-2xl font-bold text-purple-600">Q{question.questionNumber}</span>
//                 <span className={`px-3 py-1 rounded-full text-xs font-bold ${
//                   question.difficulty === "EASY" ? "bg-green-100 text-green-700" :
//                   question.difficulty === "MEDIUM" ? "bg-yellow-100 text-yellow-700" :
//                   "bg-red-100 text-red-700"
...
//       switch (sortBy) {
//         case "rank":
//           return (a.rank ?? Infinity) - (b.rank ?? Infinity); // Handle undefined rank
//         case "score":
//           return b.totalScore - a.totalScore;
//         case "accuracy":
//           return (b.accuracy ?? 0) - (a.accuracy ?? 0);
...
//       }
//     });
//     // Assign ranks if not present (e.g., backend didn't provide them)
//     sorted.forEach((p, index) => {
//       if (p.rank === undefined) p.rank = index + 1; // Assign sequential rank
//     });
//     setSortedParticipants(sorted);
//   }, [sortBy, participants]);
...
//     >
//       <div className="flex items-center justify-between mb-4">
//         <h3 className="text-lg font-bold text-gray-800">{participants.length} Participants</h3>
//         <div className="flex items-center space-x-2">
//           <span className="text-sm text-gray-600">Sort by:</span>
//           <select
//             value={sortBy}
...
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: index * 0.05 }}
//               className={`flex items-center justify-between p-4 rounded-xl border-2 transition-all hover:shadow-lg cursor-pointer ${
//                 participant.rank === 1 ? "bg-gradient-to-r from-yellow-50 to-orange-50 border-yellow-300" :
//                 participant.rank === 2 ? "bg-gradient-to-r from-gray-50 to-gray-100 border-gray-300" :
//                 participant.rank === 3 ? "bg-gradient-to-r from-orange-50 to-orange-100 border-orange-300" :
//                 "bg-white border-gray-200"
...
//                 </div>
//                 <div className="text-center">
//                   <div className="text-lg font-bold text-blue-600">{participant.correctAnswers}/{participant.questionsAnswered}</div>
//                   <div className="text-xs text-gray-500">Correct</div>
//                 </div>
//                 <div className="text-center">
//                   <div className="text-sm font-bold text-orange-600">{(participant.averageResponseTime ?? 0).toFixed(1)}s</div>
//                   <div className="text-xs text-gray-500">Avg Time</div>
//                 </div>
//                 <span className="text-xl">{expandedParticipant === participant.participantId ? "▼" : "▶"}</span>
//               </div>
//             </motion.div>
//             <AnimatePresence>
//               {expandedParticipant === participant.participantId && (
//                 <motion.div
//                   initial={{ opacity: 0, height: 0 }}
//                   animate={{ opacity: 1, height: "auto" }}
//                   exit={{ opacity: 0, height: 0 }}
//                   className="bg-gray-50 rounded-xl mt-2 p-4 border-l-4 border-purple-200"
//                 >
//                   <h4 className="text-lg font-bold text-gray-800 mb-2">Answer Breakdown</h4>
...
//                           <div className="flex items-center justify-between">
//                             <div>
//                               <span className="font-semibold text-purple-600">Q{answer.questionNumber}:</span>
//                               <span className="ml-2 text-gray-700">{answer.questionText}</span>
//                             </div>
//                             <span className={`px-2 py-1 rounded-full text-xs font-bold ${
//                               answer.isCorrect ? "bg-green-100 text-green-700" :
//                               answer.answerStatus === "INCORRECT" ? "bg-red-100 text-red-700" :
...
//                               {answer.isCorrect ? "" : ` (Correct: ${answer.correctOptionText})`}
//                             </div>
//                           )}
...
//                   )}
//                   {participant.questionsAnswered < 10 && (
//                     <div className="mt-2">
//                       <h5 className="text-md font-semibold text-gray-700 mb-1">Unattempted Questions:</h5>
//                       {[...Array(10).keys()].filter(i => !participant.answers.some(a => a.questionNumber === i + 1)).map(i => (
//                         <div key={i} className="p-3 bg-white rounded-lg border mt-1">
//                           <div className="flex items-center">
//                             <span className="font-semibold text-purple-600">Q{i + 1}</span>
//                             <span className="ml-2 text-gray-700">Unattempted</span>
//                             <span className="ml-2 px-2 py-1 rounded-full bg-gray-100 text-gray-700 text-xs font-bold">Unattempted</span>
//                           </div>
//                         </div>
//                       ))}
//                     </div>
...
//     >
//       <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6">
//         <h3 className="text-xl font-bold text-green-800 mb-4 flex items-center"><span className="mr-2">💪</span> Strengths</h3>
//         <ul className="space-y-2">{(insights?.strengths || []).map((strength, index) => <li key={index} className="flex items-start space-x-2"><span className="text-green-600 mt-1">✓</span><span className="text-green-800">{strength}</span></li>)}{(!insights.strengths || insights.strengths.length === 0) && <li className="text-green-600 italic">No specific strengths identified.</li>}</ul>
//       </div>
//       <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6">
//         <h3 className="text-xl font-bold text-red-800 mb-4 flex items-center"><span className="mr-2">⚠️</span> Areas for Improvement</h3>
//         <ul className="space-y-2">{(insights?.weaknesses || []).map((weakness, index) => <li key={index} className="flex items-start space-x-2"><span className="text-red-600 mt-1">!</span><span className="text-red-800">{weakness}</span></li>)}{(!insights.weaknesses || insights.weaknesses.length === 0) && <li className="text-red-600 italic">No areas for improvement identified.</li>}</ul>
//       </div>
//       <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6">
//         <h3 className="text-xl font-bold text-blue-800 mb-4 flex items-center"><span className="mr-2">💡</span> Recommendations</h3>
//         <ul className="space-y-2">{(insights?.recommendations || []).map((recommendation, index) => <li key={index} className="flex items-start space-x-2"><span className="text-blue-600 mt-1">→</span><span className="text-blue-800">{recommendation}</span></li>)}{(!insights.recommendations || insights.recommendations.length === 0) && <li className="text-blue-600 italic">No recommendations available.</li>}</ul>
//       </div>
//       <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
//         <div className="bg-white rounded-xl p-6 border-2 border-purple-200"><div className="text-center"><div className="text-3xl font-bold text-purple-600">{(100 - (insights?.dropoffRate ?? 0)).toFixed(1)}%</div><div className="text-sm text-gray-600 mt-2">Retention Rate</div></div></div>
//         <div className="bg-white rounded-xl p-6 border-2 border-blue-200"><div className="text-center"><div className="text-2xl font-bold text-blue-600">{insights?.engagementLevel || 'N/A'}</div><div className="text-sm text-gray-600 mt-2">Engagement Level</div></div></div>
//         <div className="bg-white rounded-xl p-6 border-2 border-green-200"><div className="text-center"><div className="text-2xl font-bold text-green-600">{insights?.difficultyBalance || 'N/A'}</div><div className="text-sm text-gray-600 mt-2">Difficulty Balance</div></div></div>
//       </div>
//     </motion.div>
//   );
// }
