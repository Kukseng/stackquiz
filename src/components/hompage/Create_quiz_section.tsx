  ...
  return (
    <div className={`w-full px-2 py-12 sm:px-3 md:px-4 lg:px-6 ${fontClass}`}>
      <div ref={sectionRef} className="max-w-3xl mx-auto">
        ...
        <div
          className={`
            relative box-radius overflow-hidden shadow-lg
          ...
          <div className="relative grid rounded-2xl md:bg-gradient-to-br from-white/1 to-white/10 lg:grid-cols-2 p-4 lg:p-8 items-center">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <p
                  className={`
                    text-lg sm:text-xl text-gray-50 font-light leading-relaxed
                    transition-all duration-1000 ease-out
                    ${
                      isVisible
                        ? "opacity-100 translate-y-0"
            ...
            {/* Right Image */}
            <div className="flex justify-center mt-8 lg:mt-0 md:justify-end">
