  ...
  return (
    <section className="px-4 py-12">
      ...
      <div className="relative w-full max-w-5xl mx-auto flex items-center justify-center">
        ...
        <button
          onClick={prev}
          className="absolute left-3 sm:left-6 top-1/2 -translate-y-1/2 text-white bg-black/40 p-3 rounded-full hover:bg-black/60 transition z-30"
        >
          <FaArrowLeft size={20} />
        </button>
        <button
          onClick={next}
          className="absolute right-3 sm:right-6 top-1/2 -translate-y-1/2 text-white bg-black/40 p-3 rounded-full hover:bg-black/60 transition z-30"
        >
