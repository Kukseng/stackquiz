...
export function WhyChooseSection() {
  ...
  // Features from locale files
  const features = [t.why.features[0], t.why.features[1], t.why.features[2]];
      ...
      <div className={`max-w-7xl mx-auto text-center ${fontClass}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          ...
          <motion.div
            ...
            className="relative rounded-2xl p-[3px] transform transition duration-300 hover:scale-105 overflow-hidden"
          >
            <div
              className={`absolute inset-0 bg-gradient-to-r ${features[0].gradient} animate-gradient-x`}
            />
            <div
              className={`relative z-10 rounded-2xl p-6 sm:p-8 text-white flex flex-col items-center ${features[0].bg}`}
            >
              ...
              <p className="text-white/90 text-center text-base sm:text-lg md:text-xl">
          ...
          >
            ...
            />
            <div
              className={`relative z-10 rounded-2xl p-6 sm:p-8 text-white flex flex-col items-center ${features[1].bg}`}
            >
              <div className="relative w-16 h-16 mb-6">
                <Image
          ...
          >
            ...
            />
            <div
              className={`relative z-10 rounded-2xl p-6 sm:p-8 text-white flex flex-col items-center ${features[2].bg}`}
            >
              <div className="relative w-16 h-16 mb-6">
                <Image
