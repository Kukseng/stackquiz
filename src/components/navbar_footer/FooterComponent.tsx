...
export default function Footer() {
  return (
    <footer className="w-full bg-footer text-white">
      {/* Main Footer Content */}
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-5 gap-8 text-center md:text-left">
      ...
      <div className="w-full border-t border-gray-600 py-4">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-center md:justify-between items-center space-y-4 md:space-y-0">
