  ...
  useEffect(() => {
    const fetchQuizzes = async () => {
      try {
        ...
        const quizzesWithQuestions = data.filter(
        ...
        {quizzes.map((quiz) => (
          ...
          >
            <CardHeader>
              ...
              <CardTitle className="text-xl text-balance line-clamp-1">
                {quiz.title}
              </CardTitle>
              <CardDescription className="text-pretty line-clamp-1">
                {quiz.description}
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-wrap gap-2">
                ...
                <Badge variant="secondary" className="flex items-center gap-1">
                  ...
                  {Math.round(
                    quiz.questions.reduce((acc, q) => acc + q.timeLimit, 0) /
              ...
              <Button
                onClick={() => {
                  ...
                  onQuizSelect(quiz); // 🧭 Trigger navigation
                }}
