  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen">
      ...
      <div className="flex flex-col items-center p-8">
        ...
        {/* "Time's Up" Heading */}
        <h2 className="text-white text-4xl font-extrabold mb-6">Corect</h2>
        {/* Alarm Clock Icon */}
        ...
        <div className="mb-8">
          ...
          <div className="w-32 h-32 flex items-center justify-center">
            <Image
              src="/play/right.svg" // Replace with your alarm clock image path
              alt="Correct"
              width={128}
              height={128}
        ...
        <div className=" px-8 py-4 rounded-xl bg-white/40 mb-4 shadow-lg ">
          <p className="text-white text-2xl font-semibold">Corect Answer !</p>
        </div>
