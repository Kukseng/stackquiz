    ...
    <Stage>
      <div className="grid gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          <Card className="p-0 overflow-hidden relative group rounded-xl">
            <img
          ...
          <Card className="p-6 md:p-8 flex flex-col justify-center bg-[#5a6fb6]/40">
            ...
            <div className="mt-7">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  size="sm"
                  className="h-10 btn-secondary rounded-full px-6 btn-text"
                >
                  Start
                </Button>
              </div>
        ...
        {/* Bottom grid: 1/2/4 columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {quizCards.map((q: CardData, i: number) => (
            <CardQuizComponent
              key={q.id}
              id={q.id}
              title={q.title}
